    ...
    <div class="company-entry">
        <form class="company-entry-form">
            <div class="company-entry-block-wrapper">
                ...
                <label class="company-entry-block-textarea-title" for="company-entry-block-textarea">Дополнительная информация: (описание проблемы)
            ...
            <div class="company-entry-block-wrapper">
                <div class="company-entry-block-row">
                    <label class="company-entry-block-row-label" for="company-entry-row-input-gos-znak">Государственный регистрационный знак:</label>
                    <input class="company-entry-block-row-input" id="company-entry-row-input-gos-znak" placeholder="Х000ХХ199">
                </div>
                <div class="company-entry-block-row">
                    <label class="company-entry-block-row-label" for="company-entry-row-input-model-auto">Модель авто:</label>
                    <input class="company-entry-block-row-input" id="company-entry-row-input-model-auto" placeholder="ГАЗ 2101">
                </div>
                <div class="company-entry-block-row">
                    <label class="company-entry-block-row-label" for="company-entry-row-input-phone">Телефон для связи:</label>
                    <input class="company-entry-block-row-input" id="company-entry-row-input-phone" placeholder="+7 (999) 999-99-99">
                </div>
                <button class="company-entry-block-button" id="company-entry-form-button" type="button">Оформить запись</button>
            </div>
        </form>
    </div>
</template>
