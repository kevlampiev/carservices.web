...
export default {
    ...
    getters: {
        wryCurrentSlot: state=> {
            const cdate= new Date(state.currentSlot.slotDateTime)
            return {
                id: state.currentSlot.id,
                name: state.currentSlot.name,
                order_id: state.currentSlot.order_id,
                service_id: state.currentSlot.service_id,
                service_type_id: state.currentSlot.service_type_id,
                work_day: cdate.toDateString(),
                work_time: cdate.getHours() + cdate.getMinutes()/60
            }
        },
    },
