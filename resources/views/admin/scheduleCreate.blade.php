...
@section('content')
    <form class="form-signin mb-3" enctype="multipart/form-data" method="POST" style="margin: 0 auto; width: 50%;" action="{{ route('admin.schedules.store') }}">
        @csrf
        ...
        <div class="mb-3">
            ...
            @endif
            <input type="date" name="work_day" id="Date" min="2021-01-01" max="2021-12-31" class="form-control" style="margin-bottom: 10px;">
