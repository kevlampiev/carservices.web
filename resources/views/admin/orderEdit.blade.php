...
@section('content')
    <form class="form-signin mb-3" enctype="multipart/form-data" method="POST" style="margin: 0 auto; width: 50%;"
        ...
        <div class="mb-3">
            ...
            @endif
            <input type="text" name="car_model" id="car_model" class="form-control" value="{{ $order['car_model'] }}"
                   placeholder="Модель" style="margin-bottom: 10px;">
            ...
            <input type="text" name="license_plate_number" id="license_plate_number" class="form-control"
                   value="{{ $order['license_plate_number'] }}" style="margin-bottom: 10px;">
